(function(){
  ...
  data_cube_wrapper.make_cube = function(){
    ...
    data_cube.initialize_cube = function(contribution_data, taxa_tree_data, func_tree_data, func_rel_abundance_data){
      ...
      /////////////////////////////////////////////////////////////////////// samples /////////////////////////////////////////////////////////////////////////////////////////////
      //reduced genus pathway metagenome contributions
      ...
      //taxa mapping
      // Read the taxa tree
      //just the mapping of the taxa on a tree structure
      ...
      /////////////////////////////////////////////////////////////////////// func_tree /////////////////////////////////////////////////////////////////////////////////////////////
      //reduced functions transpose
      // Read the func tree
      //just the mapping on the KOs on a tree structure
      ...
      for (; curr_taxa.length > 0;){
        ...
        if (!this.is_leaf(curr_taxon)){
          for (var i = 0; i < curr_taxon.values.length; i++){
            curr_taxa.push(curr_taxon.values[i]);
            console.log(curr_taxon.values[i]);
          }
        }
